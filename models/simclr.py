...
from models.loss import add_contrastive_loss
...
class SimCLR:
    def __init__(self, args):
        ...
        main_obj, background = SelfAttention(128)(self.encoder.output)
    ...
    def train(self, loader):
        ...
        # self.model.fit(loader[0][0],loader[0][1], epochs=self.args.epoch, verbose=self.args.verbose)
